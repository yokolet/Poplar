...
```
If you are using the Eclipse folder convention be sure to specify `src` directory as `src/main/java` otherwise the code will not compile. This `pom.rb` requires a `MANIFEST.MF` to create the jar see `Rakefile` below:-
```ruby
# encoding: utf-8
